...
class LyroidSlime(CellularAutomaton):
    ...
    def evolve_rule(self, last_cell_state, neighbors_last_states):
        ...
        dom_neighbour = self.__get_dominant_neighbour(neighbors_last_states,last_cell_state)
        if dom_neighbour == 1:
    ...
    @staticmethod
    def __get_dominant_neighbour(neighbours,last_cell_state):
        A_neighbors = []
        B_neighbors = []
        for n in neighbours:
            if n == SLIME_A:
